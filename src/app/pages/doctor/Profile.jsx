...
export default function DoctorProfile() {
  ...
  return (
    <>
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8 bg-[#F1F5F9]">
        <motion.div
              ...
              <div className="border-b border-gray-200 pb-6">
                ...
                <div className="flex flex-col items-center gap-4 rounded-2xl border border-dashed border-gray-300 p-6 md:flex-row">
                  {profilePicture.preview ? (
                    ...
                    <div className="h-28 w-28 rounded-full bg-gradient-to-br from-[#1E3A8A] to-[#2563EB] flex items-center justify-center text-white text-4xl">
