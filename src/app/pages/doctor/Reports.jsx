...
import { authAPI, getStoredUser, getToken } from "@/services/api.js";
      ...
      if (doctorId) {
        ...
        try {
          ...
          completedToday = orders.filter(o => {
            const orderDate = o.updatedAt ? new Date(o.updatedAt).toISOString().split('T')[0] : null;
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h1 className="text-4xl text-[#1E3A8A] mb-4">Pending Reports</h1>
