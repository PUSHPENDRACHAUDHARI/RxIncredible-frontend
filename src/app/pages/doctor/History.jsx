      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="mb-12"
          >
            <h1 className="text-4xl text-[#1E3A8A] mb-4">My Work History</h1>
                        ...
                        >
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-gray-700 font-medium">REP-{report.id}</span>
                            </div>
                          </td>
                          <td className="px-6 py-4">
        ...
        {selectedReport && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="mt-2 text-sm text-slate-500">
                        Report ID: REP-{selectedReport.id} {selectedReport.orderNumber ? `• Order ${selectedReport.orderNumber}` : ""}
                      </p>
                    </div>
              ...
              <div className="flex-1 overflow-y-auto bg-[linear-gradient(180deg,#FFFFFF_0%,#F8FBFF_100%)] p-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-gradient-to-r from-[#F7FAFF] to-[#EEF4FF] p-5">
                          ...
                          <p className="mt-3 text-lg font-semibold leading-8 text-[#173B8C]">
                            {selectedReport.diagnosis || 'No diagnosis available'}
                          </p>
                        </div>
