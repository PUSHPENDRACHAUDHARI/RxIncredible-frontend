    ...
    const stepsHtml = deliverySteps
      ...
      <div class="flex items-center gap-4 mb-6 relative ${step.completed ? "text-green-600" : index === currentStep ? "text-blue-600" : "text-gray-400"}">
        ...
        <div class="flex-1">
          ...
          ${step.date ? `<p class="text-xs text-gray-500">${new Date(step.date).toLocaleDateString("en-IN", { day: "numeric", month: "short", year: "numeric", hour: "2-digit", minute: "2-digit" })}</p>` : ""}
        </div>
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl text-[#1E3A8A] mb-4">My Orders</h1>
          ...
          {getFilteredOrders().length === 0 && (
            ...
            >
              ...
              <motion.button
                ...
                className="px-8 py-3 bg-gradient-to-r from-[#1E3A8A] to-[#2563EB] text-white rounded-xl hover:shadow-lg transition-all duration-200"
              >
                Browse Services
              </motion.button>
            </motion.div>
