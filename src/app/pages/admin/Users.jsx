    ...
    <>
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              <h1 className="text-4xl text-[#1E3A8A] mb-2">Manage Users</h1>
          ...
          >
            ...
            <select
              ...
              className="w-full px-4 py-4 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#2563EB] focus:border-transparent shadow-sm"
            >
              ...
              <form onSubmit={handleUpdateUser} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleEditInputChange}
                    className="w-full pl-4 pr-4 py-3 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#2563EB] focus:border-transparent shadow-sm"
                  >
