...
export default function AdminOrders() {
  ...
  const filteredOrders = orders.filter((order) => {
    ...
    const isOnlinePharmacy =
      orderServiceType === "ONLINE_PHARMACY" ||
      orderServiceType === "online-pharmacy";
  ...
  const stats = {
    pending: orders.filter((o) => {
      ...
      return o.status === "SUBMITTED" || o.status === "PENDING";
    }).length,
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h1 className="text-4xl text-[#1E3A8A] mb-2">Manage Orders</h1>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl text-[#2563EB]">{stats.approved}</p>
                </div>
          ...
          >
            ...
            <select
              ...
              className="px-6 py-4 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#2563EB] focus:border-transparent shadow-sm"
            >
                ...
                <tbody>
                  {filteredOrders.map((order, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        {isPrescriptionAnalysis(order) ? (
                          order.assignedAnalyst ? (
                            <span className="text-sm text-gray-700">
                              {order.assignedAnalyst.fullName}
                            </span>
                          ) : (
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`px-3 py-1 rounded-full text-sm ${getStatusBadge(order.status)}`}
                        >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-center gap-2">
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="px-4 py-2 bg-[#2563EB] text-white rounded-lg hover:bg-[#1E3A8A] transition-colors text-sm flex items-center gap-2"
                            onClick={() => {
        ...
        {showDetailsModal && selectedOrder && (
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.3 }}
              className="bg-white rounded-2xl shadow-2xl p-8 max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-3xl text-[#1E3A8A] mb-1">
                    Order Details
                  </h2>
              ...
              {/* Order Summary */}
              <div className="bg-gradient-to-r from-[#1E3A8A] to-[#2563EB] rounded-xl p-6 mb-6 text-white">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <p className="text-sm opacity-90 mb-1">Order ID</p>
                    <p className="text-2xl">{selectedOrder.orderNumber}</p>
                  </div>
                  <span
                        ...
                        {(selectedOrder.deliveryCity ||
                          ...
                          <p className="text-gray-700">
                            ...
                            {(selectedOrder.deliveryPincode ||
                              selectedOrder.user?.pincode) && <span> - </span>}
                            {selectedOrder.deliveryPincode ||
              ...
              {shouldShowPrescriptionActions(selectedOrder) && (
                <div className="mb-6">
                  ...
                  <div className="bg-gray-50 rounded-xl p-6">
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-gray-700">Prescription Status</span>
                      <span
                        className={`px-4 py-2 rounded-lg border ${
                    ...
                    <div className="flex gap-3">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="px-4 py-2 bg-gradient-to-r from-[#059669] to-[#10B981] text-white rounded-xl hover:opacity-90 transition-colors flex items-center gap-2"
                        onClick={() => handleViewPrescription(selectedOrder.id)}
                      >
                        <Eye className="w-4 h-4" />
                        View Prescription
                      </motion.button>
                      <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        className="px-4 py-2 bg-gradient-to-r from-[#2563EB] to-[#3B82F6] text-white rounded-xl hover:opacity-90 transition-colors flex items-center gap-2"
                        onClick={() =>
              ...
              {selectedOrder.orderDetails && (
                <div className="mb-6">
                  ...
                  <div className="bg-gray-50 rounded-xl p-6">
                    {(() => {
                      try {
                        const details = JSON.parse(selectedOrder.orderDetails);
                        return (
                  ...
                  selectedOrder.serviceType === "ONLINE_PHARMACY" && (
                    <>
                      ...
                      <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        className="px-4 py-2 bg-gradient-to-r from-teal-600 to-teal-500 text-white rounded-xl hover:opacity-90 transition-colors flex items-center gap-2"
                        onClick={() =>
            ...
            >
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#2563EB] focus:border-transparent"
                >
                ...
                {analysts.length === 0 ? (
                  ...
                  analysts.map((analyst) => (
                    <motion.button
                      ...
                      disabled={!analyst.isActive || Boolean(assigningAnalystId)}
                      className={`w-full p-4 rounded-xl border-2 transition-all flex items-center justify-between ${
