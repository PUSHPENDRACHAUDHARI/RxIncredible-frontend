  ...
  if (showAllUsers) {
    return (
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-8 flex justify-between items-center">
        <div>
          <h1 className="mb-2 text-4xl text-[#1E3A8A]">Prescription Bills</h1>
  ...
  return (
    <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-8">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="mb-2 text-4xl text-[#1E3A8A]">{isNewQuotation ? "New Quotation" : isViewOnly ? "View Quotation" : "Generate Quotation"}</h1>
          <p className="text-xl text-gray-600">{isNewQuotation ? "Create a new quotation without prescription" : `Order ID: ${orderData?.orderNumber}`}</p>
        </div>
      </div>
    </motion.div>
  );
