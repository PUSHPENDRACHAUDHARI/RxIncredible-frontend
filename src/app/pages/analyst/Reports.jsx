      ...
      if (analystId) {
        try {
          ...
          completedToday = orders.filter(o => {
            const updateDate = o.updatedAt ? new Date(o.updatedAt).toISOString().split('T')[0] : null;
            return o.status === 'COMPLETED' && updateDate === today;
          }).length;
          ...
          try {
            ...
            completedToday = prescriptions.filter(p => {
              const updateDate = p.updatedAt ? new Date(p.updatedAt).toISOString().split('T')[0] : null;
              return p.status === 'APPROVED' && updateDate === today;
            }).length;
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h1 className="text-4xl text-[#1E3A8A] mb-4">Pending Analysis</h1>
